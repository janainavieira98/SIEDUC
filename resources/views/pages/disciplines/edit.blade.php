...
@section('page_content')
  @include('components.breadcrumbs', [
    'items' => [
      ...
      __('Edit :entity', ['entity' => __('Discipline')]) => url()->current(),
    ]
  ])

  @component('components.card')
    @slot('header')
      <span class="text-capitalize">{{ __('Edit :entity', ['entity' => __('Discipline')]) }}</span>
    @endslot

    <form action="{{ route('disciplinas.update', request()->route('discipline')) }}" method="post">
      @csrf
      @method('PUT')

...
@section('page_content')
  @include('components.breadcrumbs', [
    'items' => [
      __('Home') => route('home'),
      'Notas e Faltas: Classe' => url()->current()
    ]
  ])
  ...
  @component('components.card')
    @slot('header')
      <div
        ...
        <span class="text-capitalize mb-2 mb-md-0">Notas e Faltas: Escolher Classe</span>
      </div>
    @endslot
        ...
        @if($records->count())
          @foreach($records as $record)
            <tr>
              ...
              <td>
                <a href="{{ route('grades.disciplines', $record) }}" class="btn btn-success">
                  <span class="fas fa-eye"/> Ver Disciplinas
                </a>
              </td>
            </tr>
          @endforeach
